...
Begin VB.Form frmSaveLinks 
   ...
   End
End
Attribute VB_Name = "frmSaveLinks"
...
Private Sub Form_Load()
   ...
   'Form
   Me.Caption = MApplication.ProductNameVersion + " - Save Links"
   
   
   'CheckBoxes
   chkTitle.Value = True
   chkAddress.Value = True
   chkCategory.Value = True
End Sub
